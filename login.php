...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <form action="controle/logar.php" method="POST" class="form-group p-3" style="background-color: rgba(0, 0, 0, 0.05);">
            <div class="form-group col-md-3">
                <label for="exampleInputLogin">Login</label>
                <input type="text" name="usuario" class="form-control" id="exampleInputLogin"
                    placeholder="Seu login">
                <small id="emailHelp" class="form-text text-muted">Nunca vamos compartilhar seu login com
                    ninguém.</small>
            </div>
            <div class="form-group col-md-3">
